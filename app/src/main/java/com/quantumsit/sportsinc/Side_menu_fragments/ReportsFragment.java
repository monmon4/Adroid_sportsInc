...
public class ReportsFragment extends Fragment {
    ...
    public void setupViewPager(ViewPager viewPager) {
        ...
        reports_sectionsPagerAdapter.addFragment(new CorsesFragment(),getString(R.string.courseReportTab));
        reports_sectionsPagerAdapter.addFragment(new PaymentFragment(),getString(R.string.paymentReportTab));
