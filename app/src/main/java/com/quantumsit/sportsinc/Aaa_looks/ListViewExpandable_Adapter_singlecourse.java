...
public class ListViewExpandable_Adapter_singlecourse extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        String score_string = context.getResources().getString(R.string.score) + ":" + String.valueOf(child.score);
        String coach_note_string = context.getResources().getString(R.string.coach_s_notes) + ": \n    " + String.valueOf(child.coach_note);
