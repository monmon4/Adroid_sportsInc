...
public class ListViewExpandable_Adapter_CoursesDetails extends BaseExpandableListAdapter {
    ...
    public ListViewExpandable_Adapter_CoursesDetails(Context context, List<item1_courses_details> listDataHeader,
                                                     HashMap<Integer, item2_courses_details> listChildData, int course_id) {
        ...
        book_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (trainee_names.size()!= 0) {
                    ...
                    globalVars.setCourse_id(course_id);
                ...
                public void onClick(View view){
                    for(int i=0; i<trainee_names.size(); i++) {
                        if (trainee_names.get(i).isSelected()) {
                            insert_to_db(trainee_names.get(i).getId(),header_list.get(groupPosition).getClass_id() ,course_id);
                        }
                    }
    ...
    private void insert_to_db(int trainee_id, int selected_class_id, int selected_course_id) {
            ...
            params.put("user_id",String.valueOf(trainee_id));
